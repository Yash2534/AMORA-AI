...
class AmoraDropdownField<T> extends StatelessWidget {
  const AmoraDropdownField({
    super.key,
    required this.label,
    required this.items,
...
class AmoraDropdownFormField<T> extends StatelessWidget {
  const AmoraDropdownFormField({
    super.key,
    required this.label,
    required this.items,
