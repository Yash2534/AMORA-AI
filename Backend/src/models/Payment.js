...
module.exports = (sequelize) => sequelize.define('Payment', {
  ...
  productType: { type: DataTypes.ENUM('subscription', 'wallet_top_up', 'boost'), allowNull: false }, productReferenceId: { type: DataTypes.STRING(64), allowNull: false }, provider: { type: DataTypes.STRING(32), allowNull: false, defaultValue: 'razorpay' },
