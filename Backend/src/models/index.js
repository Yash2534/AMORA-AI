const definitions = {
  User: require('./User'), DeletedUser: require('./DeletedUser'), OtpToken: require('./OtpToken'), RefreshToken: require('./RefreshToken'), AccountDeletionConfirmation: require('./AccountDeletionConfirmation'), AccountDeletionRequest: require('./AccountDeletionRequest'), AccountDeletionFileTask: require('./AccountDeletionFileTask'), PrivacyRequest: require('./PrivacyRequest'), PrivacyRequestConfirmation: require('./PrivacyRequestConfirmation'), PrivacyAccessResult: require('./PrivacyAccessResult'), PrivacyCorrectionDetail: require('./PrivacyCorrectionDetail'), PrivacyExportArtifact: require('./PrivacyExportArtifact'), LegalDocumentVersion: require('./LegalDocumentVersion'), ConsentEvent: require('./ConsentEvent'), OnboardingProfile: require('./OnboardingProfile'),
...
function initModels(sequelize) {
  ...
  User.hasMany(OtpToken, { foreignKey: 'userId', onDelete: 'CASCADE' }); OtpToken.belongsTo(User, { foreignKey: 'userId' });
